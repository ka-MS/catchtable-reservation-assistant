...
**갱신:** 2026-07-12
**브랜치:** `main`
**작업 로그:** `docs/worklog/2026-07-12-07-adapter-dedup.md`
...
- **타이밍 병목 진단** — 검증 실런에서 초기 시계 보정이 최종 보정 대비 1,234ms 어긋났다(−80 vs +1154, 주장 정밀도 ±302/±150을 크게 초과). 시계 동기화 metric에 샘플별 `serverDateMs`·latency·offset을 기록해 백엔드 시계 편차 가설을 실측으로 확인한다.
