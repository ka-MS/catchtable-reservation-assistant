...
7. 실제 실행은 허용된 후속 단계를 진행한 뒤 예약 폼에서 종료되며, 약관·결제 승인·최종 예약은 직접 진행합니다.
...
- 실제 사이트 슬롯 클릭은 예약 자리를 일시 점유할 수 있습니다. 신규 예약창·후속 화면은 통제된 실제 모드로 예약 폼 도착까지만 검증하며 최종 예약은 자동 테스트하지 않습니다.
